...
assign {RGF_NAME}_{REG_NAME}_{FLD_NAME}_sw_we = (paddr=={REG_ADD}) & ((apb_sts_curr==APB_WRITE) | ({LATCH} & apb_sts_curr==APB_READ)) ; // FSM is @ Write State AND register address is selected
